...
mod_ols = sm.OLS(y, X)
res_ols = mod_ols.fit()
print(res_ols.summary())  # returns summary results

res_ols.save('models/res_ols.pkl', remove_data=True)

'''
mod_glsar = sm.GLSAR(y, X, 1)
res_glsar = mod_glsar.iterative_fit(1)
'''
