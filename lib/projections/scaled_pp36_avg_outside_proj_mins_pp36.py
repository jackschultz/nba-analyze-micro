...
from .query_strings import scaled_pp36_avg_outside_proj_mins_pp36_query


def project_and_insert(date, source, version, user_id):
    full_query = scaled_pp36_avg_outside_proj_mins_pp36_query % (date, source, user_id, version, version)
